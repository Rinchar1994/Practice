...
xst -ifn xst.scr
move fenpin_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\fenpin_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc fenpin_exdes.ucf fenpin_exdes

echo 'Running map'
map -timing -pr b fenpin_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm fenpin_exdes -w routed.ncd routed.v
cd ..
